...
Es gibt deutlich mehr schlechte Noten im Verlgeich zu den guten Noten (ca. 19 % mehr).

Warum?

Weil bei den schlechten Noten mehr betrachtet wurden als bei den guten. 
...
Die Verteilung wär dann linksschief, wenn es mehr gute Noten gibt. Allerdings neigt sich der Gipfel in der Visualisierung nach links, das bedeutet in diesem Fall, dass sie rechtsschief ist.
...
3. Wie viele Studenten bekommen weniger als 10 NP?
    ...
    `r (pnorm(10,mean=mu,sd=3) - pnorm(1,mean=mu,sd=3) ) * n` Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    `r (pnorm(8,mean=mu,sd=3) - pnorm(1,mean=mu,sd=3) ) * n` Studenten bekommen weniger als 8 Notenpunkte.
